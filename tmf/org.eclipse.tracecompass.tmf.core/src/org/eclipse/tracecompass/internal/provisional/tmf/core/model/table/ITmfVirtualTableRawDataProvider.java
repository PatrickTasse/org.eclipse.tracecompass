 ...
 * @since 4.0
 */
public interface ITmfVirtualTableRawDataProvider<M extends ITmfTreeDataModel, L extends VirtualTableRawLine> extends ITmfTreeDataProvider<M> {
     ...
     */
    TmfModelResponse<ITmfVirtualRawTableModel<L>> fetchLines(Map<String, Object> fetchParameters, @Nullable IProgressMonitor monitor);
}